          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-lg mt-2">
                Unified control center for AI employees, virtual machines, and automation systems
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold">{systemOverview.completedTasks.toLocaleString()}</div>
            <div className="text-sm text-muted-foreground">Tasks Today</div>
            <div className="text-xs text-green-500">
              {systemOverview.totalTasks - systemOverview.completedTasks} in progress
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold">{formatCurrency(systemOverview.todaysCost)}</div>
        ...
        <Card className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/5">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold">{systemOverview.averageEfficiency.toFixed(1)}%</div>
        ...
        <Card className="bg-gradient-to-br from-orange-500/10 to-orange-600/5">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold">{systemOverview.userSatisfaction.toFixed(1)}%</div>
      ...
      <Tabs value={activeModule} onValueChange={setActiveModule} className="space-y-6">
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className={`p-2 rounded-lg bg-gradient-to-r ${getActionColor(action.color)}`}>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-mono">{systemOverview.systemHealth.toFixed(1)}%</span>
                    </div>
                    <Progress value={systemOverview.systemHealth} className="h-2" />
                  </div>
                  
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>AI Employee Efficiency</span>
                      <span className="font-mono">{systemOverview.averageEfficiency.toFixed(1)}%</span>
                    </div>
                    <Progress value={systemOverview.averageEfficiency} className="h-2" />
                  </div>
                  
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>User Satisfaction</span>
                      <span className="font-mono">{systemOverview.userSatisfaction.toFixed(1)}%</span>
                    </div>
                    <Progress value={systemOverview.userSatisfaction} className="h-2" />
                  </div>

                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>System Uptime</span>
                      <span className="font-mono">{systemOverview.uptime.toFixed(1)}%</span>
                    </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {recentActivities.slice(0, 5).map(activity => (
                    <div key={activity.id} className="flex items-start gap-3 p-2 hover:bg-muted/20 rounded transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-orange-600">
                    {formatCurrency(systemOverview.todaysCost / systemOverview.completedTasks)}
                  </div>
        ...
        <TabsContent value="lucky-ai" className="space-y-6">
          <Alert className="border-purple-500 bg-purple-50 dark:bg-purple-950">
            ...
            <AlertDescription>
              <strong>Lucky AI</strong> is your advanced AI assistant with VM management, bonus features, and comprehensive system oversight.
            </AlertDescription>
          </Alert>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-6">
                  Access the full-featured Lucky AI assistant with VM management, bonus systems, 
                  analytics, and comprehensive casino operations support.
                </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-6">
                  Configure workflows, triggers, and automated processes for your AI systems
                </p>
