    ...
    const mockNotifications: AdminNotification[] = [
      {
        ...
        message:
          "Luna Analytics detected 15% increase potential in VIP conversion rates by adjusting bonus multipliers during peak hours.",
      ...
      },
      {
        ...
        message:
          "Alex Support identified unusual spike in payment-related inquiries. Suggesting proactive email campaign to address common issues.",
        source: "Alex Support",
        priority: "medium",
      ...
      },
      {
        ...
        message:
          "Zara Security completed daily security scan. 0 threats detected, all systems secure. 3 minor configuration updates recommended.",
      ...
      },
      {
        ...
        message:
          "Maya Marketing reports 23% above-target performance for holiday campaign. Recommending budget increase for maximum ROI.",
      ...
      },
      {
        ...
        message:
          "Kai Operations optimized 12 database queries, reducing average response time by 340ms. System performance improved.",
  ...
  const startRealTimeUpdates = () => {
    ...
    const interval = setInterval(() => {
      setSystemStatus((prev) => ({
        ...
        systemLoad: Math.max(
          10,
          Math.min(90, prev.systemLoad + Math.floor(Math.random() * 10 - 5)),
        ),
      }));
    }, 30000);
        ...
        <div className="flex items-center justify-between h-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm">
              <div
                className={`w-2 h-2 rounded-full ${systemStatus.database === "online" ? "bg-green-400" : "bg-red-400"}`}
              />
