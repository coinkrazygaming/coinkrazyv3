...
export default function BonusManagement() {
  ...
  const loadBonusData = async () => {
    try {
      ...
      const totalClaimed = bonusesData.filter(
        (b) => b.status === "claimed",
      ).length;
      const totalGCAwarded = bonusesData.reduce(
        (sum, b) => sum + (b.gc_amount || 0),
        0,
      );
      const totalSCAwarded = bonusesData.reduce(
        (sum, b) => sum + (b.sc_amount || 0),
        0,
      );
      const pendingBonuses = bonusesData.filter(
        (b) => b.status === "pending",
      ).length;
      const claimRate =
        totalBonuses > 0 ? (totalClaimed / totalBonuses) * 100 : 0;
  ...
  const getBonusTypeColor = (type: string) => {
    switch (type) {
      ...
      case "referral":
        return "bg-casino-blue/10 text-casino-blue border-casino-blue/20";
      case "vip":
        return "bg-purple-500/10 text-purple-500 border-purple-500/20";
      case "social":
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage player bonuses and promotions
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <Card className="bg-gradient-to-br from-casino-blue/10 to-casino-blue/5 border-casino-blue/20">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-2xl font-bold">
                    {bonusStats.totalSCAwarded.toFixed(1)}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    SC Awarded
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold">
                      {bonusStats && bonusStats.totalBonuses > 0
                        ? Math.round(
                            bonusStats.totalGCAwarded / bonusStats.totalBonuses,
                          ).toLocaleString()
                        : 0}{" "}
                      GC
                    </span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold">
                      {bonusStats && bonusStats.totalBonuses > 0
                        ? (
                            bonusStats.totalSCAwarded / bonusStats.totalBonuses
                          ).toFixed(2)
                        : 0}{" "}
                      SC
                    </span>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <Badge
                            className={getBonusTypeColor(bonus.bonus_type)}
                          >
                            {bonus.bonus_type}
                          </Badge>
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <div className="flex items-center gap-4">
                          <span>
                            User: <strong>{bonus.username}</strong>
                          </span>
                          <span>
                            Created:{" "}
                ...
                {bonuses.filter((bonus) => bonus.status === "pending")
                  .length === 0 && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewBonusForm((prev) => ({ ...prev, type: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewBonusForm((prev) => ({
                        ...prev,
                        gcAmount: parseInt(e.target.value) || 0,
                      }))
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewBonusForm((prev) => ({
                        ...prev,
                        scAmount: parseFloat(e.target.value) || 0,
                      }))
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewBonusForm((prev) => ({
                        ...prev,
                        wageringRequirement: parseFloat(e.target.value) || 0,
                      }))
                    }
                  />
                </div>
