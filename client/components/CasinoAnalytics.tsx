              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs text-green-500">
                    +
                    {formatPercentage(
                      analyticsData.socialMedia.followers.growth,
                    )}
                  </span>
                </div>
              </div>
        ...
        <TabsContent value="revenue" className="mt-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {analyticsData.revenue.byPaymentMethod.map(
                    (method, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between"
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      ...
                      <div className="font-medium">
                        {formatNumber(analyticsData.banking.deposits.count)}
                      </div>
                    </div>
                    <div>
                      <div className="text-muted-foreground">Average</div>
                      <div className="font-medium">
                        {formatCurrency(analyticsData.banking.deposits.average)}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <div className="text-muted-foreground">Count</div>
                      <div className="font-medium">
                        {formatNumber(analyticsData.banking.withdrawals.count)}
                      </div>
                    </div>
                    <div>
                      <div className="text-muted-foreground">Average</div>
                      <div className="font-medium">
                        {formatCurrency(
                          analyticsData.banking.withdrawals.average,
                        )}
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <div className="text-muted-foreground">Count</div>
                      <div className="font-medium">
                        {formatNumber(analyticsData.banking.payouts.count)}
                      </div>
                    </div>
                    <div>
                      <div className="text-muted-foreground">Average</div>
                      <div className="font-medium">
                        {formatCurrency(analyticsData.banking.payouts.average)}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-xl font-bold text-gold-500">
                      {formatNumber(
                        analyticsData.banking.balances.totalGoldCoins,
                      )}
                    </div>
                  </div>
                  <div className="text-center">
                    ...
                    <div className="text-xl font-bold text-purple-500">
                      {formatNumber(
                        analyticsData.banking.balances.totalSweepsCoins,
                      )}
                    </div>
                  </div>
                  <div className="text-center">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold text-gold-500">
                      {formatNumber(analyticsData.users.vipUsers)}
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {formatPercentage(analyticsData.users.retention.day1)}
                      </span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2">
                      <div
                        className="bg-green-500 h-2 rounded-full"
                        style={{
                          width: `${analyticsData.users.retention.day1}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {formatPercentage(analyticsData.users.retention.day7)}
                      </span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2">
                      <div
                        className="bg-blue-500 h-2 rounded-full"
                        style={{
                          width: `${analyticsData.users.retention.day7}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {formatPercentage(analyticsData.users.retention.day30)}
                      </span>
                    </div>
                    <div className="w-full bg-muted rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${analyticsData.users.retention.day30}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  {analyticsData.users.demographics.map((demo, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-right">
                          <div className="font-medium">
                            {formatNumber(demo.users)}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {formatPercentage(demo.percentage)}
                          </div>
                        </div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold text-blue-500">
                      {formatCurrency(analyticsData.games.totalBets)}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">
                    ...
                    <div className="text-2xl font-bold text-green-500">
                      {formatCurrency(analyticsData.games.totalWins)}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">
                    ...
                    <div className="text-2xl font-bold text-purple-500">
                      {formatPercentage(analyticsData.games.houseEdge)}
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {formatNumber(analyticsData.games.slots.spins)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Winning Spins</span>
                    <span className="font-bold text-green-500">
                      {formatNumber(analyticsData.games.slots.hits)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Jackpots</span>
                    <span className="font-bold text-gold-500">
                      {analyticsData.games.slots.jackpots}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {formatPercentage(
                        (analyticsData.games.slots.hits /
                          analyticsData.games.slots.spins) *
                          100,
                      )}
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-500">
                      {formatNumber(analyticsData.games.sportsbook.activeBets)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {formatCurrency(
                        analyticsData.games.sportsbook.totalVolume,
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-green-500">
                      {formatCurrency(analyticsData.games.sportsbook.profit)}
                    </span>
                  </div>
                </div>
              </CardContent>
        ...
        <TabsContent value="social" className="mt-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold">
                      {analyticsData.socialMedia.posts.today}
                    </div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">
                    ...
                    <div className="text-2xl font-bold text-purple-500">
                      {formatPercentage(
                        analyticsData.socialMedia.posts.engagement,
                      )}
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-500">
                      {formatNumber(analyticsData.socialMedia.leads.generated)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">
                    ...
                    <span className="font-bold text-green-500">
                      {formatNumber(analyticsData.socialMedia.leads.converted)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">
                    ...
                    <span className="font-bold text-purple-500">
                      {formatPercentage(
                        analyticsData.socialMedia.leads.conversionRate,
                      )}
                    </span>
                  </div>
                </div>
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  {analyticsData.socialMedia.platforms.map(
                    (platform, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-3 bg-muted/20 rounded-lg"
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-500">
                      {analyticsData.socialMedia.campaigns.active}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Total Clicks</span>
                    <span className="font-bold">
                      {formatNumber(analyticsData.socialMedia.campaigns.clicks)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">
                    ...
                    <span className="font-bold text-green-500">
                      {formatPercentage(
                        analyticsData.socialMedia.campaigns.ctr,
                      )}
                    </span>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-green-500">
                      {formatNumber(analyticsData.compliance.kyc.approved)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-yellow-500">
                      {formatNumber(analyticsData.compliance.kyc.pending)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-red-500">
                      {formatNumber(analyticsData.compliance.kyc.rejected)}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-red-500">
                      {formatNumber(analyticsData.compliance.aml.flagged)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-green-500">
                      {formatNumber(analyticsData.compliance.aml.cleared)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-yellow-500">
                      {formatNumber(analyticsData.compliance.aml.underReview)}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-red-500">
                      {formatNumber(
                        analyticsData.compliance.responsible.selfExcluded,
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-yellow-500">
                      {formatNumber(
                        analyticsData.compliance.responsible.limits,
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-500">
                      {formatNumber(
                        analyticsData.compliance.responsible.alerts,
                      )}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <Badge className="bg-green-500 text-white">
                      {analyticsData.compliance.licensing.status}
                    </Badge>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Expiry Date</span>
                    <span className="font-medium">
                      {analyticsData.compliance.licensing.expiryDate}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-green-500">
                        {formatPercentage(
                          analyticsData.compliance.licensing.compliance,
                        )}
                      </span>
                      <div className="w-16 bg-muted rounded-full h-2">
                        <div
                          className="bg-green-500 h-2 rounded-full"
                          style={{
                            width: `${analyticsData.compliance.licensing.compliance}%`,
                          }}
                        ></div>
                      </div>
                    </div>
