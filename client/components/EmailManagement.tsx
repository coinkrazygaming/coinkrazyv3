          ...
          prev.map((msg) =>
            msg.id === data.data.message.id
              ? {
                  ...msg,
                  status: "responded",
                  responseId: data.data.response.id,
                }
              : msg,
          ),
        );
    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-400">
                  {analytics.aiResponseRate.toFixed(1)}%
                </p>
              </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div
                            className={`mb-2 ${!message.isRead ? "font-semibold" : ""}`}
                          >
                            {message.subject}
                          </div>
                          ...
                          <div className="text-xs text-muted-foreground mt-2 flex items-center gap-4">
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              Confidence:{" "}
                              {Math.round(message.aiAnalysis.confidence * 100)}%
                            </span>
                            <span className="flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-2">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  emailService.updateMessageStatus(
                                    message.id,
                                    "in_progress",
                                  )
                                }
                        ...
                        <div className="p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg space-y-2">
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <span
                                className={`ml-2 ${getSentimentColor(selectedMessage.aiAnalysis.sentiment)}`}
                              >
                            ...
                            <div>
                              ...
                              <span className="ml-2">
                                {selectedMessage.aiAnalysis.intent}
                              </span>
                            </div>
                            <div>
                              <span className="text-sm font-medium">
                              ...
                              <span className="ml-2">
                                {selectedMessage.aiAnalysis.urgency}/10
                              </span>
                            </div>
                          </div>
                          <div>
                            ...
                            <p className="text-sm mt-1">
                              {selectedMessage.aiAnalysis.summary}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm font-medium">
                            ...
                            <p className="text-sm mt-1 italic">
                              {selectedMessage.aiAnalysis.suggestedResponse}
                            </p>
                          </div>
                          <div>
                            <span className="text-sm font-medium">Tags:</span>
                            <div className="flex gap-1 mt-1">
                              {selectedMessage.aiAnalysis.tags.map(
                                (tag, index) => (
                                  <Badge
                                    key={index}
                                    variant="outline"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-4 gap-4 text-sm">
                            <div>
                              ...
                              {assistant.stats.emailsHandled}
                            </div>
                            <div>
                              <span className="font-medium">Avg Response:</span>{" "}
                              {assistant.stats.avgResponseTime}min
                            </div>
                            <div>
                              <span className="font-medium">Satisfaction:</span>{" "}
                              {assistant.stats.satisfactionScore}/5
                            </div>
                            <div>
                              <span className="font-medium">Accuracy:</span>{" "}
                              {assistant.stats.accuracyRate}%
                            </div>
                          </div>
                          <div className="mt-2">
                            <span className="text-sm font-medium">
      ...
      <Dialog open={aiConfigDialog} onOpenChange={setAiConfigDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              Configure AI Assistant: {selectedAI?.name}
            </DialogTitle>
          </DialogHeader>
          {selectedAI && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    type="number"
                    value={selectedAI.responseDelay}
                    readOnly
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={selectedAI.confidence_threshold}
                    readOnly
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    checked={selectedAI.autoRespond}
                    readOnly
                  />
              ...
              <div className="flex justify-end gap-2">
                <Button
                  variant="outline"
                  onClick={() => setAiConfigDialog(false)}
                >
                  Cancel
                </Button>
                <Button
