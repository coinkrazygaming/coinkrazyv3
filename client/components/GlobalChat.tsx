...
export default function GlobalChat() {
    ...
    const mockMessages: ChatMessage[] = [
      {
        ...
        userRole: "ai",
        content:
          "Welcome to CoinKrazy Global Chat! 🎰 I'm your AI moderator. Please keep the conversation casino-related and respectful. Good luck and have fun! 🍀",
      ...
      },
      {
        ...
        userRole: "user",
        content:
          "Congratulations! That's an amazing win! 🎊 What was your bet amount?",
      ...
      },
      {
        ...
        userRole: "ai",
        content:
          "🚨 Reminder: Please keep discussions related to CoinKrazy games and features. External casino promotions are not allowed. Thank you! 🤖",
      ...
      },
      {
        ...
        userRole: "user",
        content:
          "Love the new scratch cards! The Lucky Scratch Gold is so addictive! 🎯",
    ...
    if (
      ...
      setTimeout(() => {
        const aiResponse: ChatMessage = {
          ...
          userRole: "ai",
          content:
            "🤖 Hi! I'm here to help! For account issues, contact support@coinkrazy.com. For game rules, check our help section. For technical issues, our team is standing by! 🎰",
          timestamp: new Date(),
          type: "system",
          isDeleted: false,
          isEdited: false,
  ...
  const checkMessageWithAI = (message: string) => {
    ...
    if (
      inappropriateKeywords.some((keyword) => lowerMessage.includes(keyword))
    ) {
      return {
        isBlocked: true,
    ...
    switch (action) {
      ...
      case "warn":
        ...
        const warningMessage: ChatMessage = {
          ...
          userRole: "ai",
          content:
            "⚠️ Please keep conversations appropriate and casino-related. This is your warning.",
          timestamp: new Date(),
          type: "warning",
          isDeleted: false,
          isEdited: false,
          ...
          <CardHeader className="p-4 bg-gradient-to-r from-casino-blue to-purple-600 text-white rounded-t-lg">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  <Pin
                    className={`w-4 h-4 ${isPinned ? "text-gold-400" : ""}`}
                  />
                </Button>
                <Button
                  size="sm"
                ...
                {messages.map((message) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`font-medium text-sm ${getRoleColor(message.userRole)}`}
                      >
                        {message.username}
                      </span>
                      {message.userRole === "vip" && (
                        ...
                        >
                          ...
                          <div className="flex gap-1 ml-auto">
                            {user.badges.slice(0, 2).map((badge, index) => (
                              <Badge key={index} className="text-xs h-4">
                                {badge}
                              </Badge>
                            ))}
                          </div>
                  ...
                  <div className="flex gap-1 mt-3">
                    {alert.actions?.map((action, index) => (
                      <Button
                        ...
                        onClick={() =>
                          resolveAdminAlert(alert.id, action.action)
                        }
                        className="text-xs"
                      >
                        {action.label}
