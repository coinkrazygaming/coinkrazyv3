      ...
      const promotions: SweepstakesPromotion[] = [
        {
          ...
          description:
            "Enter for a chance to win amazing prizes including cash, gift cards, and electronics! No purchase necessary.",
          ...
          prizes: [
            ...
            {
              place: 5,
              description: "CoinFrazy Premium Merchandise",
              value: 50,
              quantity: 100,
            },
          ],
        ...
        },
        {
          ...
          description:
            "Weekly sweepstakes with instant prizes and entry into monthly grand prize drawing.",
          startDate: new Date("2024-01-22"),
          endDate: new Date("2024-01-28"),
          prizes: [
            {
              place: 1,
              description: "$2,500 Cash Prize",
              value: 2500,
              quantity: 1,
            },
            {
  ...
  const submitEntry = async () => {
    ...
    try {
      ...
      const missingFields = requiredFields.filter(
        (field) => !entryFormData[field as keyof typeof entryFormData],
      );
      ...
      const existingEntry = userEntries.find(
        (entry) =>
          entry.sweepstakesId === selectedPromotion.id &&
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Enter to win amazing prizes! No purchase necessary - free
              alternative entry methods available.
            </p>
          </div>
        ...
        <Alert className="mb-6 border-blue-500 bg-blue-500/10">
          ...
          <AlertDescription>
            <strong>Legal Compliance:</strong> All sweepstakes comply with
            federal and state regulations. No purchase necessary to enter or
            win. Alternative free entry methods are always provided.
            <Button
              variant="link"
        ...
        <TabsContent value="active" className="space-y-6">
          ...
          {activePromotions.filter((p) => p.isActive).length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Check back soon for new sweepstakes opportunities!
              </p>
            </div>
          )}
        </TabsContent>
        ...
        <TabsContent value="entries" className="space-y-6">
          {user ? (
              ...
              {userEntries.length > 0 ? (
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="text-sm text-muted-foreground space-y-1">
                                ...
                                {entry.mailTrackingNumber && (
                                  <div>
                                    Tracking: {entry.mailTrackingNumber}
                                  </div>
                                )}
                              </div>
                            </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    You haven't entered any sweepstakes yet. Start entering to
                    win amazing prizes!
                  </p>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Please log in to view your sweepstakes entries
              </p>
            </div>
          )}
        </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Choose from active sweepstakes
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <Alert className="mt-4">
                  ...
                  <AlertDescription>
                    Online entries are processed instantly and you receive bonus
                    GC/SC for participating!
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Fill out with legible handwriting
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Send to official address by deadline
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Alert className="mt-4">
                  ...
                  <AlertDescription>
                    Mail-in entries must be postmarked by the deadline date. Use
          ...
          <ScrollArea className="max-h-96">
            <div className="space-y-4 pr-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  By submitting this form, you agree to the official rules and
                  privacy policy. You must be 18+ and a US resident to enter.
                </AlertDescription>
              </Alert>
            </div>
          </ScrollArea>
        ...
        <DialogContent className="max-w-3xl">
          ...
          <div className="space-y-6">
                  ...
                  {selectedPromotion && (
                    <div className="space-y-3">
                      <div className="p-4 bg-muted rounded-lg font-mono text-sm">
                        ...
                        <div>
                          {selectedPromotion.mailInAddress.streetAddress}
                        </div>
                        <div>
                          {selectedPromotion.mailInAddress.city},{" "}
                          {selectedPromotion.mailInAddress.state}{" "}
                          {selectedPromotion.mailInAddress.zipCode}
                        </div>
                      </div>
                      <Button
                        variant="outline"
            ...
            <Alert>
              <Info className="h-4 w-4" />
              <AlertDescription>
                <strong>Important:</strong> Entries must be postmarked by the
                deadline. We recommend using certified mail with tracking for
          ...
          <ScrollArea className="h-96">
            <div className="space-y-4 text-sm">
              <section>
                ...
                <p>
                  Sweepstakes are open to legal residents of the United States
                  who are 18 years of age or older. Employees of CoinFrazy
                  Entertainment LLC and their immediate family members are not
                  eligible.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Entries may be submitted online through our website or by mail
                  to the address provided. All entry requirements must be met
                  for entry to be valid.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  Winners will be notified via email or phone. Response required
              ...
              <section>
                ...
                <p>
                  Prizes are as described in each sweepstakes. No cash
                  substitution except at sponsor's discretion. Taxes are
              ...
              <section>
                ...
                <p>
                  Personal information is collected and used in accordance with
                  our Privacy Policy. Winner information may be used for
