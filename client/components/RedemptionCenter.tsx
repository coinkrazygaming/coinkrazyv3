...
export default function RedemptionCenter() {
  ...
  const [redemptionOptions, setRedemptionOptions] = useState<
    RedemptionOption[]
  >([]);
  const [userHistory, setUserHistory] = useState<UserRedemptionHistory | null>(
    null,
  );
        ...
        setUserHistory({
          ...
          lifetimeRedemptions: history.lifetimeRedemptions.map((req: any) => ({
            ...
            processedDate: req.processedDate
              ? new Date(req.processedDate)
              : undefined,
            completedDate: req.completedDate
              ? new Date(req.completedDate)
              : undefined,
          })),
        });
      } else {
  ...
  const saveUserHistory = (history: UserRedemptionHistory) => {
    ...
    localStorage.setItem(
      `redemption_history_${user.id}`,
      JSON.stringify(history),
    );
  };

  const filteredOptions = redemptionOptions
    .filter((option) => {
  ...
  const handleRedemption = async (option: RedemptionOption) => {
    ...
    if (
      userHistory.monthlyRedeemed + option.scRequired >
      userHistory.monthlyLimit
    ) {
      toast({
    ...
    if (
      option.redemptionLimit &&
      userHistory.lifetimeRedemptions.filter(
        (r) => r.optionId === option.id && r.status === "completed",
      ).length >= option.redemptionLimit
    ) {
      toast({
  ...
  const confirmRedemption = async () => {
    ...
    try {
      ...
      const request: RedemptionRequest = {
        ...
        deliveryInfo: {
          type: selectedOption.isPhysical
            ? "physical"
      ...
      const updatedHistory: UserRedemptionHistory = {
        ...
        totalSCRedeemed:
          userHistory.totalSCRedeemed + selectedOption.scRequired,
        totalCashValue:
          userHistory.totalCashValue + (selectedOption.cashValue || 0),
        monthlyRedeemed:
          userHistory.monthlyRedeemed + selectedOption.scRequired,
  ...
  const simulateRedemptionProcessing = (requestId: string) => {
    ...
    toast({
      ...
      description:
        "Your redemption has been processed successfully. Check your email for details.",
    });
  };
      ...
      case "available":
        return (
          <Badge className="bg-green-600">
            Available {stockLevel && `(${stockLevel})`}
          </Badge>
        );
      case "limited":
        return (
          <Badge className="bg-yellow-600">
            Limited Stock {stockLevel && `(${stockLevel})`}
          </Badge>
        );
      case "out_of_stock":
    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">
                    {userHistory.totalSCRedeemed.toFixed(0)} SC
                  </div>
                  <div className="text-sm text-muted-foreground">
                    SC Redeemed
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">
                    ${userHistory.totalCashValue.toFixed(2)}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Cash Value
                  </div>
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {(
                      (userHistory.monthlyRedeemed / userHistory.monthlyLimit) *
                      100
                    ).toFixed(1)}
                    %
                  </span>
        ...
        <Alert className="mb-6 border-blue-500 bg-blue-500/10">
          ...
          <AlertDescription>
            <strong>Sweepstakes Compliance:</strong> Redemptions are processed
            according to sweepstakes regulations. Cash redemptions require
            identity verification. No purchase necessary to participate or win.
            <Button
              variant="link"
                  ...
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      disabled={
                        option.availability === "out_of_stock" ||
                        !wallet ||
                        wallet.sweepsCoins < option.scRequired
                      }
                    >
                      {option.availability === "out_of_stock"
                        ? "Out of Stock"
          ...
          {userHistory && userHistory.lifetimeRedemptions.length > 0 ? (
            <div className="space-y-4">
              {userHistory.lifetimeRedemptions.map((request) => {
                const option = redemptionOptions.find(
                  (opt) => opt.id === request.optionId,
                );
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            {request.deliveryInfo && (
                              <div className="text-xs text-muted-foreground">
                                Delivery:{" "}
                                {request.deliveryInfo.type === "physical"
                                  ? "Physical address"
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                Start redeeming your Sweeps Coins for great rewards!
              </p>
            ...
            <div className="space-y-4">
                ...
                {selectedOption.cashValue && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600 font-bold">
                      ${selectedOption.cashValue.toFixed(2)}
                    </span>
                  </div>
                )}
                <div className="flex justify-between">
              ...
              <div className="flex items-start gap-2">
                ...
                <Label htmlFor="terms" className="text-xs">
                  ...
                  and understand that redemptions are final.
                </Label>
              </div>
            </div>
          )}
          ...
          <ScrollArea className="h-96">
            <div className="space-y-4 text-sm">
              <section>
                ...
                <p>
                  Redemptions are available to verified users aged 18+ in
                  eligible jurisdictions. Identity verification may be required
              ...
              <section>
                ...
                <p>
                  Sweeps Coins have no cash value except when redeemed through
                  official channels. Redemptions are final and cannot be
                  reversed.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Processing times are estimates. Physical items may take longer
                  due to shipping. Digital items are typically delivered within
                  24 hours.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Monthly redemption limits apply. Some items have lifetime
                  limits. Availability is subject to change without notice.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  No purchase is necessary to obtain Sweeps Coins or participate
                  in redemptions. Alternative methods of entry are available.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Winners are responsible for all applicable taxes. Tax forms
                  may be required for redemptions over $600.
                </p>
              </section>
            </div>
          </ScrollArea>
