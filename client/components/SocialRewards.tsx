    ...
    const tasks: SocialTask[] = [
      {
        ...
        description:
          "Follow our Facebook page for updates and exclusive content",
        gcReward: 500,
        scReward: 5,
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Earn daily bonuses, complete social tasks, and refer friends for
              amazing rewards!
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Alert className="mt-6">
                ...
                <AlertDescription>
                  <strong>Login daily to maintain your streak!</strong> Bonus
                  days (every 7th day) give double rewards. Missing a day will
                  reset your streak but you can always start again.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      task.url ? openSocialLink(task) : completeSocialTask(task)
                    }
                  >
                    {task.isCompleted ? (
                      <>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    <strong>Referral Rewards:</strong> Earn 1000 GC + 10 SC for
                    each friend who joins and makes their first deposit!
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Alert>
              <Gift className="h-4 w-4" />
              <AlertDescription>
                Your friend will receive a welcome bonus, and you'll earn 1000
                GC + 10 SC when they make their first deposit!
              </AlertDescription>
            </Alert>
          </div>
