        ...
        if (event.status === "live") {
          ...
          if (updatedEvent.liveScore) {
            ...
            if (Math.random() > 0.95) {
              updatedEvent.liveScore = {
                ...updatedEvent.liveScore,
                home:
                  updatedEvent.liveScore.home + (Math.random() > 0.5 ? 1 : 0),
                away:
                  updatedEvent.liveScore.away + (Math.random() > 0.5 ? 1 : 0),
              };
            }
          }
          ...
          updatedEvent.markets = updatedEvent.markets.map((market) => ({
            ...
            outcomes: market.outcomes.map((outcome) => ({
              ...outcome,
              odds: market.isLive
                ? outcome.odds + (Math.random() - 0.5) * 0.1
                : outcome.odds,
            })),
          }));
  ...
  const placeBets = async () => {
    ...
    try {
      ...
      const newBets: Bet[] = betSlip.bets.map((betItem, index) => ({
        ...
        placedAt: new Date(),
        isLive:
          events.find((e) => e.id === betItem.eventId)?.status === "live" ||
          false,
      }));
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Live sports betting with Sweeps Coins
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* My Bets */}
          <Button variant="outline" onClick={() => setShowMyBets(!showMyBets)}>
      ...
      <Alert className="mb-6 border-purple-500 bg-purple-500/10">
        ...
        <AlertDescription>
          <strong>
            Sports betting is only available with Sweeps Coins (SC).
          </strong>{" "}
          Gold Coins cannot be used for sports wagering to ensure sweepstakes
          compliance.
        </AlertDescription>
      </Alert>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                          {market.outcomes.map((outcome) => (
                            <Button
                              ...
                              disabled={
                                !outcome.isAvailable || market.isSuspended
                              }
                              onClick={() =>
              ...
              {betSlip.bets.length === 0 ? (
                ...
                <div className="space-y-4">
                  {betSlip.bets.map((bet, index) => (
                    <div
                      key={`${bet.eventId}-${bet.marketId}-${bet.outcomeId}`}
                      ...
                      <div className="space-y-2">
                        ...
                        {bet.stake > 0 && (
                          <div className="text-xs text-muted-foreground">
                            Potential payout:{" "}
                            {(bet.stake * bet.odds).toFixed(2)} SC
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  {betSlip.totalStake > 0 && (
                    <div className="border-t pt-3">
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {betSlip.totalStake.toFixed(2)} SC
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Potential Payout:</span>
                          <span className="font-medium">
                            {betSlip.totalPayout.toFixed(2)} SC
                          </span>
                        </div>
                        <div className="flex justify-between text-green-600">
                          ...
                          <span className="font-medium">
                            +
                            {(betSlip.totalPayout - betSlip.totalStake).toFixed(
                              2,
                            )}{" "}
                            SC
                          </span>
                      ...
                      <Button
                        ...
                        onClick={placeBets}
                        disabled={
                          !wallet || wallet.sweepsCoins < betSlip.totalStake
                        }
                      >
                        Place Bets
                      </Button>
                        ...
                        .map((bet) => (
                          ...
                          >
                            ...
                            <div className="font-medium mb-1">
                              {
                                events.find((e) => e.id === bet.eventId)
                                  ?.awayTeam
                              }{" "}
                              @{" "}
                              {
                            ...
                            <div className="text-muted-foreground text-xs mb-2">
                              Stake: {bet.stake.toFixed(2)} SC • Odds:{" "}
                              {bet.odds.toFixed(2)}
                            </div>
