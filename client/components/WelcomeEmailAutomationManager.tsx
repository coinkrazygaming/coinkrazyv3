...
export default function WelcomeEmailAutomationManager() {
  ...
  const [selectedSequence, setSelectedSequence] =
    useState<WelcomeEmailSequence | null>(null);
  ...
  useEffect(() => {
    ...
    const unsubscribe = welcomeEmailAutomationService.subscribe(
      (event, data) => {
        switch (event) {
          case "email_sent":
  ...
  const loadMetrics = () => {
    ...
    const sequenceMetrics = welcomeEmailAutomationService.getSequenceMetrics(
      selectedSequence.id,
    );
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/20">
        <CardHeader>
          ...
          <p className="text-muted-foreground">
            Manage automated welcome email sequences and user onboarding
            journeys
          </p>
        </CardHeader>
      </Card>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-500">
                  {formatNumber(
                    journeys.reduce((sum, j) => sum + j.emailsSent, 0),
                  )}
                </p>
              </div>
                ...
                <p className="text-2xl font-bold text-green-500">
                  {journeys.length > 0
                    ? (
                        (journeys.reduce(
                          (sum, j) =>
                            sum + j.emailsOpened / Math.max(j.emailsSent, 1),
                          0,
                        ) /
                          journeys.length) *
                        100
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-500">
                  {journeys.length > 0
                    ? (
                        (journeys.filter((j) => j.conversions > 0).length /
                          journeys.length) *
                        100
                      ).toFixed(1)
                    : 0}
                  ...
                  {sequences.map((sequence) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-3 h-3 rounded-full ${sequence.isActive ? "bg-green-500" : "bg-gray-500"}`}
                        />
                        <div>
                          <div className="font-medium">{sequence.name}</div>
                          <div className="text-sm text-muted-foreground">
                            {sequence.emails.length} emails •{" "}
                            {sequence.metrics.totalTriggered} triggered
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {sequence.metrics.averageOpenRate.toFixed(1)}% open
                          rate
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              Step {journey.currentStep} • {journey.emailsSent}{" "}
                              emails sent
                            </div>
                          </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-blue-600 dark:text-blue-400">
                      Consider adding a 3-day follow-up email to the standard
                      sequence to improve conversion rates by an estimated 15%.
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-green-600 dark:text-green-400">
                      VIP welcome sequence shows 23% higher engagement. Consider
                      A/B testing premium elements in standard sequence.
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-600 dark:text-yellow-400">
                      12 users have been stuck on email verification step for
                      over 24 hours. Consider sending a reminder email.
                    </p>
                  </div>
                </div>
              </CardContent>
                    ...
                    {sequences.map((sequence) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                          <span>
                            Triggered: {sequence.metrics.totalTriggered}
                          </span>
                          <span>
                            Completed: {sequence.metrics.totalCompleted}
                          </span>
                        </div>
                      </div>
                    ))}
              ...
              {selectedSequence ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div className="text-center p-3 bg-muted/20 rounded-lg">
                          <div className="text-2xl font-bold">
                            {selectedSequence.emails.length}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            Total Emails
                          </div>
                        ...
                        <div className="text-center p-3 bg-muted/20 rounded-lg">
                          <div className="text-2xl font-bold">
                            {selectedSequence.metrics.totalTriggered}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            Triggered
                          </div>
                        ...
                        <div className="text-center p-3 bg-muted/20 rounded-lg">
                          <div className="text-2xl font-bold">
                            {selectedSequence.metrics.averageOpenRate.toFixed(
                              1,
                            )}
                            %
                          </div>
                        ...
                        <div className="text-center p-3 bg-muted/20 rounded-lg">
                          <div className="text-2xl font-bold">
                            {(
                              selectedSequence.metrics.conversionRate * 100
                            ).toFixed(1)}
                            %
                          </div>
                          <div className="text-sm text-muted-foreground">
                            ...
                            .map((email, index) => (
                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-sm text-muted-foreground">
                                    Trigger:{" "}
                                    {email.trigger.type.replace("_", " ")}
                                    {email.trigger.delayMinutes &&
                                      ` (${email.trigger.delayMinutes}min delay)`}
                                  </div>
                                </div>
                                <div className="flex items-center gap-2">
                                  <Badge
                                    variant={
                                      email.isActive ? "default" : "secondary"
                                    }
                                  >
                ...
                <Card>
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                      Choose a sequence from the list to view details and manage
                      email steps
                    </p>
                  </CardContent>
                </Card>
                      ...
                      >
                        ...
                        <td className="p-3">
                          <span className="capitalize">
                            {sequences.find((s) => s.id === journey.sequenceId)
                              ?.name || journey.sequenceId}
                          </span>
                        </td>
                        <td className="p-3">
                          <Badge className={getStatusColor(journey.status)}>
                          ...
                          <div className="flex gap-1">
                            {journey.status === "active" ? (
                              ...
                              <Button
                                ...
                                variant="outline"
                                onClick={() =>
                                  resumeUserJourney(journey.userId)
                                }
                              >
                                <Play className="w-3 h-3" />
                              </Button>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">
                    Detailed analytics and trends would be displayed here with
                    charts and graphs
                  </p>
                </div>
              </CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      "KYC Completion Celebration" has the highest conversion
                      rate at 47.3%
                    </p>
                    <Button size="sm" variant="outline">
                      View Details
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Adding a 2-day delay to "Getting Started" email could
                      increase opens by 18%
                    </p>
                    <Button size="sm" variant="outline">
                      Apply Suggestion
                    </Button>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Test subject line variations for "First Week Check-in"
                      email
                    </p>
                    <Button size="sm" variant="outline">
                      Create Test
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-medium">
                      Auto-start sequences for new users
                    </span>
                    <p className="text-sm text-muted-foreground">
                      Automatically trigger welcome sequences when users
                      register
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Automatically adjust sending rate based on engagement
                    </p>
                  </div>
                  <Button variant="outline" size="sm">
                    Enabled
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Monitor and retry failed email deliveries
                    </p>
                  </div>
                  <Button variant="outline" size="sm">
                    Enabled
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="font-medium">
                    Minimum delay between emails (hours)
                  </label>
