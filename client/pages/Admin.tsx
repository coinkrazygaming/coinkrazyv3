...
// Mock data
const mockUsers = [
  { id: 1, username: "player123", email: "player123@email.com", status: "active", kyc: "verified", gcBalance: 125000, scBalance: 450, joinDate: "2024-01-15", lastLogin: "2024-03-20" },
  { id: 2, username: "casinofan", email: "fan@email.com", status: "suspended", kyc: "pending", gcBalance: 89000, scBalance: 0, joinDate: "2024-02-10", lastLogin: "2024-03-19" },
  { id: 3, username: "highroller", email: "high@email.com", status: "active", kyc: "verified", gcBalance: 450000, scBalance: 1250, joinDate: "2024-01-05", lastLogin: "2024-03-20" },
  { id: 4, username: "newbie2024", email: "new@email.com", status: "active", kyc: "rejected", gcBalance: 50000, scBalance: 25, joinDate: "2024-03-18", lastLogin: "2024-03-20" },
];

const mockGames = [
  { id: 1, name: "Sweet Bonanza", provider: "Pragmatic Play", status: "active", rtp: 96.48, players: 423, revenue24h: 12450, enabled: true },
  { id: 2, name: "Josey Duck Game", provider: "CoinKrazy", status: "active", rtp: 96.8, players: 723, revenue24h: 18750, enabled: true },
  { id: 3, name: "Gates of Olympus", provider: "Pragmatic Play", status: "maintenance", rtp: 96.5, players: 0, revenue24h: 0, enabled: false },
  { id: 4, name: "Colin Shots", provider: "CoinKrazy", status: "active", rtp: 97.2, players: 612, revenue24h: 15250, enabled: true },
];

const mockTransactions = [
  { id: 1, user: "player123", type: "withdrawal", amount: 150, currency: "SC", status: "pending", date: "2024-03-20 14:30" },
  { id: 2, user: "highroller", type: "deposit", amount: 500, currency: "GC", status: "completed", date: "2024-03-20 13:15" },
  { id: 3, user: "casinofan", type: "withdrawal", amount: 75, currency: "SC", status: "flagged", date: "2024-03-20 12:00" },
  { id: 4, user: "newbie2024", type: "deposit", amount: 100, currency: "GC", status: "completed", date: "2024-03-20 11:45" },
];
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveStats(prev => ({
        ...
        systemHealth: Math.max(95, Math.min(100, prev.systemHealth + (Math.random() - 0.5) * 0.1))
      }));
    }, 3000);
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Management Dashboard & AI Assistant</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <Button variant="outline" className="bg-red-500/10 border-red-500 text-red-400">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{liveStats.totalUsers.toLocaleString()}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{liveStats.activeNow.toLocaleString()}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">${liveStats.revenue24h.toLocaleString()}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{liveStats.pendingWithdrawals}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{liveStats.systemHealth.toFixed(1)}%</p>
                </div>
                          ...
                          <td className="p-2">
                            <Badge 
                              variant={
                                ...
                                user.kyc === 'pending' ? 'secondary' : 'destructive'
                              }
                            >
                              {user.kyc}
                            </Badge>
                          </td>
                          <td className="p-2 font-mono">{user.gcBalance.toLocaleString()}</td>
                          <td className="p-2 font-mono text-gold-400">{user.scBalance}</td>
                    ...
                    <tbody>
                      {mockGames.map((game) => (
                        <tr key={game.id} className="border-b border-border/50 hover:bg-muted/50">
                          ...
                          <td className="p-2 text-gold-400">${game.revenue24h.toLocaleString()}</td>
                          <td className="p-2">
                            <div className="flex gap-1">
                              <Button 
                                size="sm" 
                                variant={game.enabled ? "outline" : "default"}
                                className={game.enabled ? "text-orange-500" : "bg-green-500 hover:bg-green-600"}
                              >
                                {game.enabled ? <Pause className="w-3 h-3" /> : <Play className="w-3 h-3" />}
                              </Button>
                              <Button size="sm" variant="outline">
                    ...
                    <div className="space-y-3">
                      <div className="border border-red-500/20 rounded-lg p-3 bg-red-500/5">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-medium text-red-400">Suspicious Pattern Detected</span>
                      ...
                      <div className="border border-orange-500/20 rounded-lg p-3 bg-orange-500/5">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-medium text-orange-400">RTP Anomaly</span>
                          <Badge variant="outline" className="border-orange-500 text-orange-400">MEDIUM</Badge>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          "Sweet Bonanza" RTP deviation detected: 102.3% over last 1000 spins.
                        </p>
                      ...
                      <div className="border border-blue-500/20 rounded-lg p-3 bg-blue-500/5">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-medium text-blue-400">Auto-Resolved Support</span>
                          <Badge variant="outline" className="border-blue-500 text-blue-400">INFO</Badge>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          Automatically resolved 3 password reset requests and 1 bonus claim inquiry.
                        </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border border-border rounded-lg p-4 h-64 bg-muted/20 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground">Lucky AI Assistant</p>
                        <p className="text-sm text-muted-foreground">Voice + Text interface integration</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="bg-green-500/5 border-green-500/20">
                      <CardContent className="p-4">
                        ...
                        <p className="text-sm text-muted-foreground">Last audit: 2 hours ago</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-blue-500/5 border-blue-500/20">
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold text-blue-400">✓ Clean</p>
                        <p className="text-sm text-muted-foreground">Last scan: 30 minutes ago</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-orange-500/5 border-orange-500/20">
                      <CardContent className="p-4">
                        ...
                        <p className="text-2xl font-bold text-orange-400">⚠ Due</p>
                        <p className="text-sm text-muted-foreground">Last backup: 22 hours ago</p>
                      </CardContent>
                    </Card>
                  </div>
                </div>
