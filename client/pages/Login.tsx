      ...
      <div className="bg-gradient-to-r from-casino-blue/10 via-gold/5 to-casino-blue/10 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-lg">Login to continue your winning streak</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <Card className="border-gold-500/20">
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground">Access your account and continue playing</p>
            </CardHeader>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Join thousands of players winning real cash prizes daily through our legal sweepstakes platform.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "700+ slot games from top providers like Pragmatic Play and NetEnt"
                },
                {
                  icon: Shield,
                  title: "Secure & Legal",
                  description: "Fully compliant sweepstakes model with advanced security measures"
                },
                {
                  icon: Smartphone,
                  title: "Mobile Optimized",
                  description: "Play anywhere with our mobile-first responsive design"
                },
                {
                  icon: AlertTriangle,
                  title: "Responsible Gaming",
                  description: "Built-in tools and limits to promote healthy gaming habits"
                }
              ].map((feature, index) => (
            ...
            <div className="bg-gradient-to-r from-gold/5 to-casino-blue/5 rounded-lg p-6 border border-gold-500/20">
              ...
              <p className="text-muted-foreground mb-4">
                Get started with 100,000 Gold Coins + 50 Sweeps Coins + 7 Days VIP when you sign up!
              </p>
              <Link to="/register">
