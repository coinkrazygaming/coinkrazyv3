...
export default function Poker() {
  ...
  const getVariantName = (variant: string) => {
    switch (variant) {
      ...
      case "7-card-stud":
        return "7-Card Stud";
      case "jailhouse-spades":
        return "Jailhouse Spades";
      default:
        return variant;
    }
  };
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-lg">
              Professional poker tables running 24/7
            </p>
          </div>
        </div>
      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="text-sm text-right">
                          <div className="text-gold-400">
                            {table.buyIn.gc.toLocaleString()} GC
                          </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-medium">
                              {getVariantName(tournament.type)}
                            </div>
                          </div>
                          <div>
                            <span className="text-muted-foreground">
                            ...
                            <div className="font-medium">
                              {tournament.buyIn.gc.toLocaleString()} GC +{" "}
