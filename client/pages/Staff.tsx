...
export default function Staff() {
  ...
  const handleTicketStatusUpdate = async (
    ...
    const success = staffService.updateTicketStatus(
      ticketId,
      status,
      user?.id || "",
    );
  ...
  const handleEscalateTicket = async (ticketId: string, reason: string) => {
    const success = staffService.escalateTicket(
      ticketId,
      reason,
      user?.id || "",
    );
  ...
  const handleKycUpdate = async (
    ...
    const success = staffService.updateKycStatus(
      userId,
      status,
      notes,
      user?.id || "",
  ...
  const handleAddUserNote = async () => {
    ...
    const success = staffService.addUserNote(
      selectedUser.id,
      newUserNote,
      user?.id || "",
    );
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-red-500">
                      Urgent Alerts Require Attention
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {urgentAlerts.length} high priority alert
                      {urgentAlerts.length > 1 ? "s" : ""} need immediate action
                    </p>
                  </div>
                </div>
                <Button
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold">
                      {avgResponseTime.toFixed(0)} minutes
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm bg-muted/20 p-3 rounded">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handleEscalateTicket(
                              selectedTicket.id,
                              "AI recommendation: Complex issue requiring escalation",
                            )
                          }
                        >
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <Badge
                              className={getStatusColor(selectedUser.kycStatus)}
                            >
                      ...
                      <div>
                        ...
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span>
                              {selectedUser.balances.goldCoins.toLocaleString()}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span>Sweeps Coins:</span>
                            <span>
                              {selectedUser.balances.sweepsCoins.toFixed(2)}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span>USD:</span>
                        ...
                        <div>
                          ...
                          <div className="max-h-32 overflow-y-auto space-y-1">
                            {selectedUser.notes.slice(-5).map((note, index) => (
                              <div
                                key={index}
                                className="text-xs bg-muted/20 p-2 rounded"
                              >
                                {note}
                              </div>
                            ))}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    ...
                    <p className="text-sm">
                      JoseyAI has identified 12 new high-value leads from social
                      media today. 3 require immediate attention.
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <p className="text-sm">
                      Your response time is 23% faster than team average. Keep
                      up the great work!
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    ...
                    <p className="text-sm">
                      Consider escalating ticket #001 - customer sentiment
                      analysis shows increasing frustration.
                    </p>
                  </div>
                </CardContent>
              </Card>
