        ...
        <Card className="max-w-2xl mx-auto border-gold-500/20 bg-gradient-to-r from-gold/5 to-casino-blue/5">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Your email has been verified successfully! Your welcome bonus has
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          <Card
            className={
              verificationStatus === "error" ? "border-red-500/20" : ""
            }
          >
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Play responsibly. If you have a gambling problem, call
              1-800-GAMBLER.
            </p>
          </div>
        </div>
