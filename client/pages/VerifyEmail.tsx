...
export default function VerifyEmail() {
  ...
  useEffect(() => {
    const handleVerification = async () => {
      if (!token) {
        setStatus('error');
        setMessage('Invalid verification link. Please check your email for a valid verification link.');
        return;
      }
          ...
          <CardContent className="space-y-6">
            ...
            {status === 'success' && (
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <h3 className="text-xl font-bold mb-4">Welcome Bonus Added!</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link to="/register">
                      <Button 
                        className="w-full sm:w-auto bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-black font-bold"
                      >
                        Register Again
                      </Button>
                    </Link>
