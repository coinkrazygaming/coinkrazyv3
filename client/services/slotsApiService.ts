  ...
  private readonly providers: SlotProvider[] = [
    {
      ...
      apiKey: process.env.REACT_APP_PRAGMATIC_API_KEY || "demo-key",
      isActive: true,
      gameCount: 200,
    ...
    },
    {
      ...
      apiKey: process.env.REACT_APP_NETENT_API_KEY || "demo-key",
      isActive: true,
      gameCount: 150,
      supportedCurrencies: ["GC", "SC", "USD"],
    },
    {
      ...
      apiKey: process.env.REACT_APP_PLAYTECH_API_KEY || "demo-key",
      isActive: true,
      gameCount: 180,
      supportedCurrencies: ["GC", "SC", "USD"],
    },
    {
      ...
      apiKey: process.env.REACT_APP_MICROGAMING_API_KEY || "demo-key",
      isActive: true,
      gameCount: 300,
      supportedCurrencies: ["GC", "SC", "USD"],
    },
    {
      ...
      apiKey: process.env.REACT_APP_EVOLUTION_API_KEY || "demo-key",
      isActive: true,
      gameCount: 50,
      supportedCurrencies: ["GC", "SC", "USD"],
    },
