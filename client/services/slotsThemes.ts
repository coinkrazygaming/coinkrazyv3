    ...
    prizes: [
      {
        ...
        type: "SC",
        amount: 500,
        description: "1st Place: 500 SC",
      },
      {
        position: 2,
        type: "SC",
        amount: 250,
        description: "2nd Place: 250 SC",
      },
      {
        position: 3,
        type: "SC",
        amount: 100,
        description: "3rd Place: 100 SC",
      },
      {
        position: 10,
        type: "GC",
        amount: 50000,
        description: "Top 10: 50K GC",
      },
    ],
    participants: 847,
    ...
    prizes: [
      {
        ...
        type: "cash",
        amount: 1000,
        description: "1st Place: $1,000 Cash",
      },
      {
        position: 2,
        type: "cash",
        amount: 500,
        description: "2nd Place: $500 Cash",
      },
      {
        position: 3,
        type: "cash",
        amount: 250,
        description: "3rd Place: $250 Cash",
      },
    ],
    participants: 234,
    maxParticipants: 500,
...
export class SlotsThemeService {
  ...
  getActiveThemeBoosts(): {
    experienceMultiplier: number;
    bonusChance: number;
    jackpotMultiplier: number;
  } {
    return (
      this.currentTheme?.gameBoosts || {
